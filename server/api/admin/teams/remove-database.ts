...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // Проверяем, имеет ли команда доступ к этой базе данных
    ...
    // Удаляем связь команды с базой данных
    await db
    ...
    return {
      status: "success",
      message: "Доступ к базе данных успешно отозван у команды",
      team: teamExists[0],
    ...
    throw createError({
      statusCode: 500,
      statusMessage: "Failed to revoke database access from team",
