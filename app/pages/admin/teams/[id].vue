        ...
        <UForm :state="editState" class="space-y-6" @submit="updateTeam">
          ...
          <div class="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
            <div class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
              <UIcon name="i-heroicons-pencil-square" class="text-blue-600 dark:text-blue-400 text-xl" />
            </div>
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Изменить команду</h3>
              <p class="text-sm text-gray-500 dark:text-gray-400">Обновите информацию о команде</p>
            </div>
          </div>
          ...
          <div class="space-y-5">
            ...
            <UFormGroup label="Описание команды" name="description">
              ...
              />
              <template #help>
                <span class="text-xs text-gray-500">Описание поможет участникам понять цель команды</span>
              </template>
            </UFormGroup>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
            <div class="p-2 bg-red-100 dark:bg-red-900/30 rounded-lg">
              <UIcon name="i-heroicons-exclamation-triangle" class="text-red-600 dark:text-red-400 text-xl" />
            </div>
            <div>
              <h3 class="text-lg font-semibold text-red-600 dark:text-red-400">Подтверждение удаления</h3>
          ...
          <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <div class="space-y-3">
              <p class="text-gray-900 dark:text-gray-100 font-medium">
                ...
                <span class="font-bold text-red-600 dark:text-red-400">"{{ teamName }}"</span>?
              </p>
              
              <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <p class="flex items-center gap-2">
                  <UIcon name="i-heroicons-x-circle" class="text-red-500 text-base" />
          ...
          <!-- Поле подтверждения -->
          <div>
            <UFormGroup label="Для подтверждения введите название команды:" required>
              <UInput
